      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <Link
              to="/pricing"
              className="block w-full px-4 py-2 text-center bg-white border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors"
            >
              Buy More Credits
            </Link>
          </div>
        ...
        <div className="bg-gray-50 rounded-xl p-6 flex items-center justify-between">
          ...
          <button className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg text-gray-600 hover:text-gray-900 transition-colors">
            Contact Support
